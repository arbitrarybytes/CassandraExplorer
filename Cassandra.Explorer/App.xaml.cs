...
namespace Cassandra.Explorer
{
    ...
    public partial class App : Application
    {
        ...
        {
            MessageBox.Show($"An unhandled error was encountered while performing your request.\n{e.Exception.Message}", "Cassandra Explorer", MessageBoxButton.OK, MessageBoxImage.Error);
        }
